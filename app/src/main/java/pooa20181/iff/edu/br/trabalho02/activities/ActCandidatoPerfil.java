...
public class ActCandidatoPerfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_candidato_perfil);
        ...
        if(id != 0) {
            ...
            edtNumeroVotos.setText(candidato.getNumVotos());
            edtCargo.setText(candidato.getCargo());
            edtNumeroUrna.setText(candidato.getNumUrna());
    ...
    public void setEgrava(Candidato candidato)
    {
        ...
        candidato.setNumVotos(edtNumeroVotos.getText().toString());
        candidato.setNumUrna(edtNumeroUrna.getText().toString());
